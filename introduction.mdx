...
<Warning>
  TestForge servers **never receive** your user stories, acceptance criteria, or generated tests. All LLM calls go browser-direct from your ADO tab to the endpoint you configure.
</Warning>